...
static char selfloatcolor[]              = "#808080";
...
static const char *const autostart[] = {
	"feh", "--no-fehbg", "--bg-fill", "/home/davyjones/suckless/wallpapers/wall.png", NULL,
	"sh", "-c", "asusctl profile -P Quiet >/dev/null 2>&1 || true", NULL,
	"fcitx5", "-d", "--replace", NULL,
	"sh", "-c", "exec picom", NULL,
	"sh", "-c", "exec slstatus", NULL,
	"sh", "-c", "exec nm-applet", NULL,
	"sh", "-c", "for agent in /usr/lib/polkit-gnome/polkit-gnome-authentication-agent-1 /usr/libexec/polkit-gnome-authentication-agent-1; do [ -x \"$agent\" ] && exec \"$agent\"; done; exit 0", NULL,
	NULL /* terminate */
};
...
static const Rule rules[] = {
	...
	RULE(.class = "Pavucontrol", .isfloating = 0)
	RULE(.class = "Nm-connection-editor", .isfloating = 0)
	RULE(.class = "Chromium", .title = "Picture-in-Picture", .isfloating = 1)
	RULE(.class = "Google-chrome", .title = "Picture-in-Picture", .isfloating = 1)
...
static const char *screenshotcmd[] = { "screenshot-area", NULL };
